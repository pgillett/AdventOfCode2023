...
public class Day04Test
{
    ...
    [TestMethod]
    public void RealDataPart1ShouldBe24706()
    {
        var expectedResult = 24706;
    
        var actualResult = _day04.Part1(InputData.Day04);
    
        actualResult.Should().Be(expectedResult);
    }
    
    [TestMethod]
    public void RealDataPart2ShouldBe13114317()
    {
        var expectedResult = 13114317;
    
        var actualResult = _day04.Part2(InputData.Day04);
